...
<input class="float w100 h40" type="hidden" id="g-recaptcha-response" name="g-recaptcha-response" required>
      <form name="formAdd" id="formAdd" method="post" action="<?php echo DIRPAGE.'controllers/ControllerAdd.php';?>">
        <div class="container-sm">
            <input type="text" name="title" id="title" class="form-control" placeholder="Informe seu nome" aria-describedby="helpId" required>
            ...
            <br>
            <button id="marcar" class="btn btn-outline-primary" type="submit"><span class="icon">
