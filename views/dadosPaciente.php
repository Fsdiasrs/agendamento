             ...
             for($i=0; $i<$index; $i++){
                echo "<tr>";
                        ...
                        <a class='btn btn-sm btn-primary' href='".DIRPAGE."editUsuario?id=".$b['data'][$i]['id']." 'title='Editar'>
                            ...
                            <a id = 'deleteCad' class='btn btn-sm btn-danger' href='".DIRPAGE."controllers/controllerDeleteCad?id=".$b['data'][$i]['id']."' data-confirm ='Tem certeza que deseja deletar este registro?' title='Deletar'>
