...
$('#cpf , #dataNascimento, #telefoneEmp, #telefoneResid, #telefonePessoal').on('focus', function () {
    var id=$(this).attr("id");
    ...
    if(id == "telefonePessoal"){VMasker(document.querySelector("#telefonePessoal")).maskPattern("(99)99999-9999")};
});
...
(function(win,doc){
    ...
    function getCalendar(perfil, div)
    {
        ...
        footerToolbar:{
            start: '',
            center: 'prev dayGridMonth,timeGridWeek,today next',
            end: ''
        },
            droppable: true,
            editable:true,
